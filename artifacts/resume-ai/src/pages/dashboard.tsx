...
import { FileText, Briefcase, FileCheck, Upload, PlusCircle, ArrowRight, TrendingUp } from "lucide-react";
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 mb-8">
        <StatCard label="Documents" value={stats?.documentCount ?? 0} icon={FileText} isLoading={isLoading} />
        <StatCard label="Job Listings" value={stats?.jobCount ?? 0} icon={Briefcase} isLoading={isLoading} />
        <StatCard label="Applications" value={stats?.applicationCount ?? 0} icon={FileCheck} isLoading={isLoading} />
        <StatCard label="Completed" value={stats?.completedApplications ?? 0} icon={TrendingUp} isLoading={isLoading} />
      </div>
